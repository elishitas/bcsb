...
public class DatosUtilidad {
    ...
    public static List<Personaje> creacionPersonajes() {
        ...
        Personaje personaje2 = new Personaje
                ("Walter Mitty", 42, 52.2f, "Walter Mitty (Stiller) es un hombre soñador que trabaja como editor gráfico en la revista LIFE y que escapa de su aburrida vida gracias a su imaginación, inventando mundos de fantasía en los que se convierte en un verdadero héroe.");
        Personaje personaje3 = new Personaje
                ("Derek Zoolander", 33, 53.3f, "Derek Zoolander (Ben Stiller) ha sido por tres temporadas consecutivas el Top Model número uno. Pero la cresta de la fama es inestable");
        Personaje personaje4 = new Personaje
                ("Ted Stehman", 20, 54.4f, "Trece años después sigue suspirando por la misma chica");
        Personaje personaje5 = new Personaje
                ("Jennifer Lopez", 53, 55.5f, "La superestrella mundial reflexiona sobre su polifacética carrera y la presión que supone vivir bajo los focos");
        ...
        Personaje personaje7 = new Personaje
                ("Emma Stone", 33, 57.7f, "La historia de La La Land:Un estado mental ensoñador y eufórico alejado de las más duras realidades de la vida");
        Personaje personaje8 = new Personaje
                ("Miles Teller", 28, 58.8f, "El protagonista aprende de memoria durante una larga noche de práctica compulsiva y lacerante");
        Personaje personaje9 = new Personaje
                ("Mei Lee", 16, 59.9f, "Una niña se debate entre seguir siendo la hija obediente que su madre quiere que sea y el caos de la adolescencia");
        Personaje personaje10 = new Personaje
                ("Luca", 7, 50.10f, "Dos niños emprenden una aventura entre humanos que odian a los monstruos.");
